...
appRouter() => nyRoutes((router) {
      ...
      router.route(BrowseCategoryPage.path, (context) => BrowseCategoryPage(), transition: PageTransitionType.fade);

      router.route(BrowseSearchPage.path, (context) => BrowseSearchPage(), transition: PageTransitionType.fade);

      router.route(ProductDetailPage.path, (context) => ProductDetailPage(), transition: PageTransitionType.rightToLeftWithFade);

      router.route(ProductReviewsPage.path, (context) => ProductReviewsPage(), transition: PageTransitionType.rightToLeftWithFade);

      router.route(LeaveReviewPage.path, (context) => LeaveReviewPage(), transition: PageTransitionType.rightToLeftWithFade);

      router.route(ProductImageViewerPage.path, (context) => ProductImageViewerPage(), transition: PageTransitionType.fade);

      router.route(WishListPageWidget.path, (context) => WishListPageWidget(), transition: PageTransitionType.rightToLeftWithFade);

      router.route(AccountOrderDetailPage.path, (context) => AccountOrderDetailPage(), transition: PageTransitionType.rightToLeftWithFade);

      router.route(CheckoutStatusPage.path, (context) => CheckoutStatusPage(), transition: PageTransitionType.rightToLeftWithFade);

      router.route(CheckoutDetailsPage.path, (context) => CheckoutDetailsPage(), transition: PageTransitionType.bottomToTop);

      router.route(CheckoutPaymentTypePage.path, (context) => CheckoutPaymentTypePage(), transition: PageTransitionType.bottomToTop);

      router.route(CheckoutShippingTypePage.path, (context) => CheckoutShippingTypePage(), transition: PageTransitionType.bottomToTop);

      router.route(CouponPage.path, (context) => CouponPage(), transition: PageTransitionType.bottomToTop);

      router.route(HomeSearchPage.path, (context) => HomeSearchPage(), transition: PageTransitionType.bottomToTop);

      router.route(CustomerCountriesPage.path, (context) => CustomerCountriesPage(), transition: PageTransitionType.bottomToTop);
      ...
      router.route(AccountProfileUpdatePage.path, (context) => AccountProfileUpdatePage());
